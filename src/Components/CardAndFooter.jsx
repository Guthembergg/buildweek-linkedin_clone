...
const CardAndFooter = () => {
  ...
  return (
    <div className="cardFooter">
      <div className="card px-3 card-body">
        ...
        <div className="innerCard">
          ...
          <div>
            <BsFillPersonFill className="innerCardIcon" />
            <GrKey className="innerCardIcon" />
          </div>
      ...
      <div className="secondFooter">
        <ul>
          ...
          <li>
            Privacy e condizioni <IoMdArrowDropdown className="arrowGiu" />
          </li>
          <li>Opzioni per gli annunci pubblicitari</li>
          <li>Pubblicità</li>
          <li>
            Servizi alle aziende <IoMdArrowDropdown className="arrowGiu" />
          </li>
        ...
        <div className="footerCopirightDiv">
          <h3>Linkedin</h3>
          <span className="footerCopiright footerCopiright2">
